...
ELEMENT_META = {
    ...
    71:  ("Lu",  "Lutetium",        6, 3,  6,  4),
    72:  ("Hf",  "Hafnium",         6, 4,  6,  5),
    73:  ("Ta",  "Tantalum",        6, 5,  6,  6),
    74:  ("W",   "Tungsten",        6, 6,  6,  7),
    75:  ("Re",  "Rhenium",         6, 7,  6,  8),
    76:  ("Os",  "Osmium",          6, 8,  6,  9),
    77:  ("Ir",  "Iridium",         6, 9,  6,  10),
    78:  ("Pt",  "Platinum",        6, 10, 6,  11),
    79:  ("Au",  "Gold",            6, 11, 6,  12),
    80:  ("Hg",  "Mercury",         6, 12, 6,  13),
    81:  ("Tl",  "Thallium",        6, 13, 6,  14),
    82:  ("Pb",  "Lead",            6, 14, 6,  15),
    83:  ("Bi",  "Bismuth",         6, 15, 6,  16),
    84:  ("Po",  "Polonium",        6, 16, 6,  17),
    85:  ("At",  "Astatine",        6, 17, 6,  18),
    86:  ("Rn",  "Radon",           6, 18, 6,  18),
    87:  ("Fr",  "Francium",        7, 1,  7,  1),
    88:  ("Ra",  "Radium",          7, 2,  7,  2),
    89:  ("Ac",  "Actinium",        7, 3,  7,  3),
    ...
    103: ("Lr",  "Lawrencium",      7, 3,  7,  4),
    104: ("Rf",  "Rutherfordium",   7, 4,  7,  5),
    105: ("Db",  "Dubnium",         7, 5,  7,  6),
    106: ("Sg",  "Seaborgium",      7, 6,  7,  7),
    107: ("Bh",  "Bohrium",         7, 7,  7,  8),
    108: ("Hs",  "Hassium",         7, 8,  7,  9),
    109: ("Mt",  "Meitnerium",      7, 9,  7,  10),
    110: ("Ds",  "Darmstadtium",    7, 10, 7,  11),
    111: ("Rg",  "Roentgenium",     7, 11, 7,  12),
    112: ("Cn",  "Copernicium",     7, 12, 7,  13),
    113: ("Nh",  "Nihonium",        7, 13, 7,  14),
    114: ("Fl",  "Flerovium",       7, 14, 7,  15),
    115: ("Mc",  "Moscovium",       7, 15, 7,  16),
    116: ("Lv",  "Livermorium",     7, 16, 7,  17),
    117: ("Ts",  "Tennessine",      7, 17, 7,  18),
